...
export default defineHopeConfig({
  ...
  lang: 'en-US',
  // title: 'HDID Net',
  description: 'HDID.Net : Hierarchical decentralized identity self-sovereign network', 
  head: [ 
    ['link', { rel: 'manifest', href: '/manifest.webmanifest' }],
    ['link', { rel: 'apple-touch-icon', sizes: '180x180', href: '/images/icons/apple-touch-icon.png' }],
    ['link', { rel: 'mask-icon', color: '#4908f1', href: '/images/icons/safari-pinned-tab.svg' }],
  ...
  locales: { 
    ...
    '/zh/': {
      lang: 'zh-CN',
      description: 'HDID Net : 分层去中心化身份 DID 自主网络。',
    },
  },
